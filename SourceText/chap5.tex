...
\begin{itemize}
    \item \textbf{Kết quả tự kiểm thử lúc khởi động:} Quá trình chạy thử 50 mẫu tĩnh tại startup hoàn tất trơn tru. Từ confusion matrix được in ra màn hình Serial, mô hình đạt Accuracy \textbf{100\%}, Precision \textbf{100\%}, và Recall \textbf{100\%} trên tập kiểm thử tĩnh 50 mẫu, minh chứng mô hình đã được chuyển đổi đúng sang định dạng C-array và suy luận chính xác trên thư viện TensorFlow Lite Micro.
...
Để minh họa trực quan và sống động quá trình vận hành đồng thời của các tác vụ FreeRTOS, giao diện điều khiển Web Server cục bộ, luồng đẩy dữ liệu lên đám mây CoreIOT cũng như khả năng suy luận thời gian thực của mô hình TinyML trên bo mạch, nhóm đã thực hiện ghi hình quá trình chạy thực tế của hệ thống tại đường dẫn sau:
\begin{itemize}
