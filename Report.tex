...
\usepackage{enumitem}
\usepackage[left=2.3cm,right=2cm,top=2.5cm,bottom=2.5cm,headheight=39pt]{geometry} 
...
\fancyhead[L]{
 \begin{tabular}{rl}
    ...
    \put(0,-8){\includegraphics[width=8.7mm, height=8.7mm]{SourceImage/LogoBK.png}}
   \end{picture}&
	\begin{tabular}{l}
...
\fancyfoot[L]{\footnotesize \ttfamily \textcolor{blue}{Internet of Things Assignment - HK252}}
...
\include{0. Bìa}
\include{0. Danh sách thành viên}
% \include{0. Bảng viết tắt}
% \newpage
% {%
% \let\oldnumberline\numberline%
...
\input{SourceText/toc}
%\end{comment}
%\include{00.Nhật ký hoạt động}
